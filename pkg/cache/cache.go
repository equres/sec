...
const (
	...
	SECLastSevenDaysDownloadsCount  string = "cache.SECLastSevenDaysDownloadsCount"
	SECLastSevenDaysIndexesCount    string = "cache.SECLastSevenDaysIndexesCount"
	SECLastSuccessfulBackupToCa2    string = "cache.SECLastSuccessfulBackupToCa2"
	SECLastSuccessfulBackupToWaw1   string = "cache.SECLastSuccessfulBackupToWaw1"
	SECLastSuccessfulDBBackup       string = "cache.SECLastSuccessfulDBBackup"
	SECLastSuccessfulDBBackupToCa2  string = "cache.SECLastSuccessfulDBBackupToCa2"
	SECLastSuccessfulDBBackupToWaw1 string = "cache.SECLastSuccessfulDBBackupToWaw1"
)
